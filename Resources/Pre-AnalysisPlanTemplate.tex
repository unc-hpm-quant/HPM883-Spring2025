...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, toprule=.15mm, bottomtitle=1mm, arc=.35mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colback=white, rightrule=.15mm, coltitle=black, left=2mm, breakable, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, titlerule=0mm, opacitybacktitle=0.6]
