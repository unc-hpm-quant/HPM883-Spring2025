...
# HPM 883 Random Question Generator
...
**Important**: To share flagged questions with Sean, click the gear icon (⚙️) in the top-right corner, enter the admin password when prompted, then click "Export CSV" to download your flagged questions report. Please send this CSV file to Sean in Slack.
:::
