...
## What can we do about it? Hidden Treatment Versions
...
$$\text{ATE} = P(R=1) \cdot E[Y_i(1) - Y_i(0) | R_i = 1] + P(R=0) \cdot E[Y_i(1) - Y_i(0) | R_i = 0]$$
...
- **GHO tests** (Ghanem, Hirshleifer, Ortiz-Becerra, 2020):
  - Use regression with baseline outcome as dependent variable:
    $Y_{i0} = \pi_{11}D_iR_i + \pi_{01}(1-D_i)R_i + \pi_{10}D_i(1-R_i) + \pi_{00}(1-D_i)(1-R_i) + \epsilon_i$
...
::: {.notes}
Monotonicity assumption typically rules out the existence of defiers
:::
