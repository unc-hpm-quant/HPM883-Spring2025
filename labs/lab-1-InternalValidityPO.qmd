...
1. Download the dataset: [Insert Link Here]
2. Open this `.qmd` file in RStudio or another Quarto-supported editor.
3. Follow the guided coding prompts below, completing the missing code blocks.
4. Run the interactive **WebR** code blocks in your browser to check your work.
5. Submit your completed lab on **Gradescope** [Insert Link Here] by **[Insert Deadline Here]**.
